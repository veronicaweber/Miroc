...
# Time coordinate for later 21st century part of run from 2015 - 2010 -BUT let's narrow down the historical period to just focus on 2015 - 2055 (like we did for BCC Model )
...
origin="1/01/2015"
enddate="12/01/2055"
miroc_clt_time_2015_2055 <- seq.dates(origin, enddate, by="months")
...
origin="1/01/2015"
enddate="12/01/2055"
miroc_ts_time_2015_2055 <- seq.dates(origin, enddate, by="months")
...
ts_hist_2015_2055 <- ncvar_get(miroc_ts_ssp_2015_2100, "ts")-273.15
...
origin="1/01/2015"
enddate="12/01/2055"
miroc_rsdscs_time_2015_2055 <- seq.dates(origin, enddate, by="months")
